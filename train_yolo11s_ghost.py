...
MODEL_CFG = Path("ultralytics/cfg/models/11/yolo11s-ghost.yaml")
PRETRAINED_WEIGHTS = "yolo11s.pt"
DEFAULT_DEVICE = "0"  # Change to "cpu" if you do not have an NVIDIA GPU available.


def parse_args():
    parser = argparse.ArgumentParser(description="Train a YOLO11s + Ghost backbone model.")
    ...
    parser.add_argument("--name", default="yolo11s_ghost", help="Experiment name.")

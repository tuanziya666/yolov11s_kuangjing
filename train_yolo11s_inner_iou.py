...
def parse_args():
    parser = argparse.ArgumentParser(description="Train a YOLO11s baseline model with Inner-IoU bbox regression loss.")
    ...
    parser.add_argument("--name", default="yolo11s_inner_iou", help="Experiment name.")

...
MODEL_CFG = Path("ultralytics/cfg/models/11/yolo11s-msee.yaml")
PRETRAINED_WEIGHTS = "yolo11s.pt"
DEFAULT_DEVICE = "0"


def parse_args():
    parser = argparse.ArgumentParser(description="Train a YOLO11s + MSEE model.")
    ...
    parser.add_argument("--name", default="yolo11s_msee", help="Experiment name.")
